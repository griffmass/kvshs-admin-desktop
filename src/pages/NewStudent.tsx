...
export default function NewStudent() {
  ...
  const filteredStudents = students.filter((student) => {
    ...
    return matchesSearch && matchesStrand && matchesGradeLevel && matchesAlphabetical && matchesSex && matchesLRN;
  }).sort((a, b) => {
  ...
  return (
    <div className="w-full">
      <div className="border-b-2 border-gray-300 pb-2 mb-4">
        <h2 className="text-lg font-bold text-gray-800">LIST OF ALL NEW ENROLLEES:</h2>
      </div>
                  ...
                  <td className="py-3 px-6">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-1.5 bg-red-400 text-white text-xs rounded hover:bg-red-600 disabled:opacity-50"
                        title="Delete"
                      >
                        <Trash2 size={14} />
                      </button>
                      {student.strand === 'ALS' ? (
                        <button
                          ...
                          disabled={processing === student.lrn}
                          className="flex items-center space-x-1 px-3 py-1 bg-blue-400 text-white text-xs rounded hover:bg-blue-600 disabled:opacity-50"
                        >
                          <CheckCircle size={14} />
                        ...
                        <button
                          ...
                          disabled={processing === student.lrn}
                          className="flex items-center space-x-1 px-3 py-1 bg-green-400 text-white text-xs rounded hover:bg-green-600 disabled:opacity-50"
                        >
                          <CheckCircle size={14} />
                          <span>Enroll</span>
                        </button>
